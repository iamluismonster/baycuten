   ...
   states: {
      "Base State": {
         "${_btninicio}": [
            ...
            ["transform", "translateY", '3.99998px']
         ],
         "${_btnprecios}": [
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid233", tween: [ "transform", "${_btninicio}", "translateY", '3.99998px', { fromValue: '3.99998px'}], position: 0, duration: 0 },
            { id: "eid243", tween: [ "transform", "${_btninicio}", "translateY", '73px', { fromValue: '3.99998px'}], position: 750, duration: 250 },
