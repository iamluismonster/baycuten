...
"stage": {
   ...
   states: {
      "Base State": {
         ...
         "${_referencias}": [
            ["transform", "translateX", '737.85602px'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid259", tween: [ "transform", "${_referencias}", "translateY", '73px', { fromValue: '35px'}], position: 750, duration: 250 },
            ...
            { id: "eid256", tween: [ "transform", "${_referencias}", "translateX", '737.85602px', { fromValue: '737.85602px'}], position: 0, duration: 0 },
