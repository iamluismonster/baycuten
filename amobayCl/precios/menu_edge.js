...
"stage": {
   ...
   states: {
      "Base State": {
         ...
         "${_referencias}": [
            ["transform", "translateX", '741.31204px'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid270", tween: [ "transform", "${_referencias}", "translateY", '73px', { fromValue: '35px'}], position: 750, duration: 260 },
            ...
            { id: "eid267", tween: [ "transform", "${_referencias}", "translateX", '741.31204px', { fromValue: '741.31204px'}], position: 0, duration: 0 },
