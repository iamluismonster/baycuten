   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid257", tween: [ "transform", "${_referencias}", "translateY", '73px', { fromValue: '35px'}], position: 750, duration: 260 },
            ...
            { id: "eid254", tween: [ "transform", "${_referencias}", "translateX", '741.31207px', { fromValue: '741.31207px'}], position: 0, duration: 0 },
