...
"stage": {
   ...
   states: {
      "Base State": {
         ...
         "${_referencias}": [
            ["transform", "translateX", '741.31199px'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid257", tween: [ "transform", "${_referencias}", "translateY", '35px', { fromValue: '35px'}], position: 0, duration: 0 },
            { id: "eid261", tween: [ "transform", "${_referencias}", "translateY", '73px', { fromValue: '35px'}], position: 750, duration: 250 },
            ...
            { id: "eid258", tween: [ "transform", "${_referencias}", "translateX", '741.31199px', { fromValue: '741.31199px'}], position: 0, duration: 0 },
            ...
            { id: "eid250", tween: [ "transform", "${_btnpresentacionesover2}", "translateY", '3px', { fromValue: '3px'}], position: 0, duration: 0 },
            { id: "eid255", tween: [ "transform", "${_btnpresentacionesover2}", "translateY", '73px', { fromValue: '3px'}], position: 750, duration: 260 },
            ...
            { id: "eid249", tween: [ "transform", "${_btnpresentacionesover2}", "translateX", '279px', { fromValue: '279px'}], position: 0, duration: 0 },
            { id: "eid251", tween: [ "transform", "${_btnpresentacionesover2}", "translateX", '279px', { fromValue: '279px'}], position: 750, duration: 0 },
            { id: "eid253", tween: [ "transform", "${_btnpresentacionesover2}", "translateX", '279px', { fromValue: '279px'}], position: 1010, duration: 0 },
