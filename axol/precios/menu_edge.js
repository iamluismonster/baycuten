...
"stage": {
   ...
   content: {
      dom: [
        ...
        {
            id:'btnpreciosover3',
            className:'stage_btnpreciosover3_id',
            type:'image',
            tag:'div',
            rect:[0,0,154,27],
            fill:['rgba(0,0,0,0)','images/btnpreciosover3.jpg']
        },
        {
            id:'referencias',
            type:'image',
   ...
   states: {
      "Base State": {
         ...
         "${_referencias}": [
            ["transform", "translateX", '741.31206px'],
         ...
         "${_btnpreciosover3}": [
            ["transform", "translateX", '424.99999px'],
            ["transform", "translateY", '3px']
         ],
         "${_refresh}": [
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid268", tween: [ "transform", "${_referencias}", "translateY", '34.99998px', { fromValue: '34.99998px'}], position: 0, duration: 0 },
            { id: "eid270", tween: [ "transform", "${_referencias}", "translateY", '73px', { fromValue: '34.99998px'}], position: 750, duration: 250 },
            ...
            { id: "eid267", tween: [ "transform", "${_referencias}", "translateX", '741.31206px', { fromValue: '741.31206px'}], position: 0, duration: 0 },
            ...
            { id: "eid261", tween: [ "transform", "${_btnpreciosover3}", "translateY", '3px', { fromValue: '3px'}], position: 0, duration: 0 },
            { id: "eid266", tween: [ "transform", "${_btnpreciosover3}", "translateY", '73px', { fromValue: '3px'}], position: 750, duration: 260 },
            ...
            { id: "eid256", tween: [ "transform", "${_btnpreciosover3}", "translateX", '424.99999px', { fromValue: '424.99999px'}], position: 0, duration: 0 },
            { id: "eid262", tween: [ "transform", "${_btnpreciosover3}", "translateX", '424.99999px', { fromValue: '424.99999px'}], position: 750, duration: 0 },
            { id: "eid264", tween: [ "transform", "${_btnpreciosover3}", "translateX", '424.99999px', { fromValue: '424.99999px'}], position: 1010, duration: 0 },
