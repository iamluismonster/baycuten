...
"stage": {
   ...
   states: {
      "Base State": {
         ...
         "${_referencias}": [
            ["transform", "translateX", '739.85603px'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid258", tween: [ "transform", "${_referencias}", "translateY", '73px', { fromValue: '35px'}], position: 750, duration: 260 },
            ...
            { id: "eid256", tween: [ "transform", "${_referencias}", "translateX", '739.85603px', { fromValue: '739.85603px'}], position: 0, duration: 0 },
