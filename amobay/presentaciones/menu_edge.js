...
"stage": {
   ...
   states: {
      "Base State": {
         ...
         "${_referencias}": [
            ["transform", "translateX", '741.31212px'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid257", tween: [ "transform", "${_referencias}", "translateY", '34px', { fromValue: '34px'}], position: 0, duration: 0 },
            { id: "eid259", tween: [ "transform", "${_referencias}", "translateY", '73px', { fromValue: '34px'}], position: 750, duration: 250 },
            ...
            { id: "eid256", tween: [ "transform", "${_referencias}", "translateX", '741.31212px', { fromValue: '741.31212px'}], position: 0, duration: 0 },
