   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid255", tween: [ "transform", "${_referencias}", "translateY", '34px', { fromValue: '34px'}], position: 0, duration: 0 },
            { id: "eid257", tween: [ "transform", "${_referencias}", "translateY", '73px', { fromValue: '34px'}], position: 750, duration: 250 },
            ...
            { id: "eid254", tween: [ "transform", "${_referencias}", "translateX", '741.31204px', { fromValue: '741.31204px'}], position: 0, duration: 0 },
