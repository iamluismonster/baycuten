...
"stage": {
   ...
   states: {
      "Base State": {
         ...
         "${_referencias}": [
            ["transform", "translateX", '741.31213px'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid268", tween: [ "transform", "${_referencias}", "translateY", '34px', { fromValue: '34px'}], position: 0, duration: 0 },
            { id: "eid270", tween: [ "transform", "${_referencias}", "translateY", '73px', { fromValue: '34px'}], position: 750, duration: 250 },
            ...
            { id: "eid267", tween: [ "transform", "${_referencias}", "translateX", '741.31213px', { fromValue: '741.31213px'}], position: 0, duration: 0 },
