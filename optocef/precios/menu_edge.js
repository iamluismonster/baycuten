...
"stage": {
   ...
   states: {
      "Base State": {
         ...
         "${_referencias}": [
            ["transform", "translateX", '739.58399px'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid268", tween: [ "transform", "${_referencias}", "translateY", '35px', { fromValue: '35px'}], position: 0, duration: 0 },
            { id: "eid270", tween: [ "transform", "${_referencias}", "translateY", '73px', { fromValue: '35px'}], position: 750, duration: 250 },
            ...
            { id: "eid267", tween: [ "transform", "${_referencias}", "translateX", '739.58399px', { fromValue: '739.58399px'}], position: 0, duration: 0 },
