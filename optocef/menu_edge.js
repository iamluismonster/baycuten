...
"stage": {
   ...
   content: {
      dom: [
        ...
        {
            id:'btninicioover2',
            className:'stage_btninicioover2_id',
            type:'image',
            tag:'div',
            rect:[0,0,120,27],
            fill:['rgba(0,0,0,0)','images/btninicioover2.jpg']
        },
        {
            id:'referencias',
            type:'image',
   ...
   states: {
      "Base State": {
         ...
         "${_referencias}": [
            ["transform", "translateX", '737.85603px'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid255", tween: [ "transform", "${_referencias}", "translateY", '35px', { fromValue: '35px'}], position: 0, duration: 0 },
            { id: "eid257", tween: [ "transform", "${_referencias}", "translateY", '73px', { fromValue: '35px'}], position: 750, duration: 250 },
            ...
            { id: "eid254", tween: [ "transform", "${_referencias}", "translateX", '737.85603px', { fromValue: '737.85603px'}], position: 0, duration: 0 },
            ...
            { id: "eid250", tween: [ "transform", "${_btninicioover2}", "translateY", '3px', { fromValue: '3px'}], position: 0, duration: 0 },
            { id: "eid253", tween: [ "transform", "${_btninicioover2}", "translateY", '73px', { fromValue: '3px'}], position: 750, duration: 260 },
            ...
            { id: "eid249", tween: [ "transform", "${_btninicioover2}", "translateX", '9px', { fromValue: '9px'}], position: 0, duration: 0 },
            { id: "eid251", tween: [ "transform", "${_btninicioover2}", "translateX", '9px', { fromValue: '9px'}], position: 750, duration: 0 },
