...
"stage": {
   ...
   content: {
      dom: [
        ...
        {
            id:'btnbeneficiosover',
            className:'stage_btnbeneficiosover_id',
            type:'image',
            tag:'div',
            rect:[0,0,137,27],
            fill:['rgba(0,0,0,0)','images/btnbeneficiosover.jpg']
        },
        {
            id:'btninicio',
   ...
   states: {
      "Base State": {
         ...
         "${_referencias}": [
            ["transform", "translateX", '745.99996px'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid245", tween: [ "transform", "${_referencias}", "translateY", '36px', { fromValue: '36px'}], position: 0, duration: 0 },
            { id: "eid247", tween: [ "transform", "${_referencias}", "translateY", '73px', { fromValue: '36px'}], position: 750, duration: 260 },
            ...
            { id: "eid214", tween: [ "transform", "${_btnbeneficiosover}", "translateX", '136px', { fromValue: '136px'}], position: 0, duration: 0 },
            { id: "eid224", tween: [ "transform", "${_btnbeneficiosover}", "translateX", '136px', { fromValue: '136px'}], position: 750, duration: 0 },
            { id: "eid242", tween: [ "transform", "${_referencias}", "translateX", '745.99996px', { fromValue: '745.99996px'}], position: 0, duration: 0 },
            ...
            { id: "eid227", tween: [ "transform", "${_btnbeneficiosover}", "translateY", '73.00001px', { fromValue: '3px'}], position: 750, duration: 260 },
