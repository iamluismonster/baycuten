...
"stage": {
   ...
   content: {
      dom: [
        ...
        {
            id:'btnpresentacionesover2',
            className:'stage_btnpresentacionesover2_id',
            type:'image',
            tag:'div',
            rect:[0,0,137,27],
            fill:['rgba(0,0,0,0)','images/btnpresentacionesover2.jpg']
        },
        {
            id:'referencias',
   ...
   states: {
      "Base State": {
         ...
         "${_referencias}": [
            ["transform", "translateX", '737.8561px'],
         ...
         "${_btnpresentacionesover2}": [
            ["transform", "translateX", '278.99998px'],
            ["transform", "translateY", '3px']
         ],
         "${_btnprecios}": [
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid270", tween: [ "transform", "${_btnbeneficios}", "translateY", '4px', { fromValue: '3px'}], position: 0, duration: 750 },
            { id: "eid201", tween: [ "transform", "${_btnbeneficios}", "translateY", '73.00001px', { fromValue: '4px'}], position: 750, duration: 250 },
            { id: "eid1", tween: [ "style", "${_stage}", "width", '1024px', { fromValue: '1024px'}], position: 0, duration: 0 },
            { id: "eid272", tween: [ "transform", "${_btnpresentacionesover2}", "translateX", '278.99999px', { fromValue: '278.99998px'}], position: 0, duration: 750 },
            { id: "eid268", tween: [ "transform", "${_btnpresentaciones}", "translateY", '4px', { fromValue: '3px'}], position: 0, duration: 750 },
            { id: "eid198", tween: [ "transform", "${_btnpresentaciones}", "translateY", '73.00001px', { fromValue: '4px'}], position: 750, duration: 250 },
            { id: "eid275", tween: [ "transform", "${_referencias}", "translateY", '34px', { fromValue: '34px'}], position: 0, duration: 0 },
            { id: "eid277", tween: [ "transform", "${_referencias}", "translateY", '73px', { fromValue: '34px'}], position: 750, duration: 250 },
            ...
            { id: "eid266", tween: [ "transform", "${_btnpresentacionesover2}", "translateY", '4px', { fromValue: '3px'}], position: 0, duration: 750 },
            { id: "eid273", tween: [ "transform", "${_btnpresentacionesover2}", "translateY", '73px', { fromValue: '4px'}], position: 750, duration: 260 },
            { id: "eid274", tween: [ "transform", "${_referencias}", "translateX", '737.8561px', { fromValue: '737.8561px'}], position: 0, duration: 0 },
            ...
            { id: "eid264", tween: [ "transform", "${_btninicio}", "translateY", '4px', { fromValue: '3px'}], position: 0, duration: 750 },
            { id: "eid226", tween: [ "transform", "${_btninicio}", "translateY", '73.00001px', { fromValue: '4px'}], position: 750, duration: 260 },
            ...
            { id: "eid262", tween: [ "transform", "${_btnprecios}", "translateY", '4px', { fromValue: '3px'}], position: 0, duration: 750 },
            { id: "eid202", tween: [ "transform", "${_btnprecios}", "translateY", '73.00001px', { fromValue: '4px'}], position: 750, duration: 250 },
