...
"stage": {
   ...
   content: {
      dom: [
        ...
        {
            id:'btnpreciosover2',
            className:'stage_btnpreciosover2_id',
            type:'image',
            tag:'div',
            rect:[0,0,154,27],
            fill:['rgba(0,0,0,0)','images/btnpreciosover2.jpg']
        },
        {
            id:'referencias',
   ...
   states: {
      "Base State": {
         ...
         "${_referencias}": [
            ["transform", "translateX", '741.31202px'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid250", tween: [ "transform", "${_referencias}", "translateY", '34px', { fromValue: '34px'}], position: 0, duration: 0 },
            { id: "eid252", tween: [ "transform", "${_referencias}", "translateY", '73px', { fromValue: '34px'}], position: 750, duration: 250 },
            ...
            { id: "eid243", tween: [ "transform", "${_btnpreciosover2}", "translateY", '3px', { fromValue: '3px'}], position: 0, duration: 0 },
            { id: "eid248", tween: [ "transform", "${_btnpreciosover2}", "translateY", '73px', { fromValue: '3px'}], position: 750, duration: 260 },
            ...
            { id: "eid238", tween: [ "transform", "${_btnpreciosover2}", "translateX", '425px', { fromValue: '425px'}], position: 0, duration: 0 },
            { id: "eid244", tween: [ "transform", "${_btnpreciosover2}", "translateX", '425px', { fromValue: '425px'}], position: 750, duration: 0 },
            { id: "eid246", tween: [ "transform", "${_btnpreciosover2}", "translateX", '425px', { fromValue: '425px'}], position: 1010, duration: 0 },
            ...
            { id: "eid249", tween: [ "transform", "${_referencias}", "translateX", '741.31202px', { fromValue: '741.31202px'}], position: 0, duration: 0 },
