...
"stage": {
   ...
   content: {
      dom: [
        ...
        {
            id:'btninicioover',
            className:'stage_btninicioover_id',
            type:'image',
            tag:'div',
            rect:[0,0,120,27],
            fill:['rgba(0,0,0,0)','images/btninicioover.jpg']
        },
        {
            id:'btnbeneficios',
   ...
   states: {
      "Base State": {
         ...
         "${_referencias}": [
            ["transform", "translateX", '741.31201px'],
         ...
         "${_btninicioover}": [
            ["transform", "translateX", '8.63999px'],
            ["transform", "translateY", '3px']
         ]
      }
   },
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid196", tween: [ "transform", "${_btninicioover}", "translateY", '73.00001px', { fromValue: '3px'}], position: 750, duration: 250 },
            { id: "eid198", tween: [ "transform", "${_btnpresentaciones}", "translateY", '73.00001px', { fromValue: '3px'}], position: 750, duration: 250 },
            { id: "eid231", tween: [ "transform", "${_referencias}", "translateY", '35px', { fromValue: '35px'}], position: 0, duration: 0 },
            { id: "eid233", tween: [ "transform", "${_referencias}", "translateY", '73px', { fromValue: '35px'}], position: 750, duration: 250 },
            ...
            { id: "eid50", tween: [ "transform", "${_btninicioover}", "translateX", '8.63999px', { fromValue: '8.63999px'}], position: 0, duration: 0 },
            { id: "eid152", tween: [ "transform", "${_btninicioover}", "translateX", '8.63999px', { fromValue: '8.63999px'}], position: 750, duration: 0 },
            { id: "eid182", tween: [ "transform", "${_btninicioover}", "translateX", '8.63999px', { fromValue: '8.63999px'}], position: 1000, duration: 0 },
            { id: "eid230", tween: [ "transform", "${_referencias}", "translateX", '741.31201px', { fromValue: '741.31201px'}], position: 0, duration: 0 },
